...
- 🐛 曾写过 两年的易语言+爬虫开发，期间接触并深入学习了[自动化和逆向工程](/blog/2020-year-end-summary/)，后转型 JS/TS 全栈开发。
...
<p style={{ display: 'flex', 'align-items': 'center', gap: '0.5rem' }}>
  ...
  <a href={social.email.href} target="_blank">719371164@qq.com</a>
</p>
